...
<!DOCTYPE html>
<html>
<title>La carica delle 101 attivit&agrave;</title>
<head>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Invia l'email
        $subject = "INFO (LA CARICA DELLE 101 ATTIVITA)";
        $message = "<p>Ciao, sono Bianchi Veronica.</p>
        <p>Grazie per aver chiesto informazioni.</p>
        <p>Il libro contiene 101 attivit&agrave; didattiche pratiche che stimoleranno lo sviluppo del movimento, della comunicazione e del linguaggio, la creativit&agrave;, l'immaginazione, la coordinazione oculo-manuale, i sensi. Attivit&agrave; utili per lo sviluppo della percezione e della logica, la fantasia, la concentrazione e molto altro.</p>
        ...
        <p>L'importo &egrave; di 9,99 euro.</p>
    ...
    ?>
    <div>
        <h1>Disponibile in PDF (via e-mail)</br>e-book con 101 attività per bambini dai 6 mesi.</br>💥IL PREZZO E' DI SOLI 9,99€</h1></br>
