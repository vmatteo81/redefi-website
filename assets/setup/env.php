...
if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'Sql1708424_1');
if (!defined('DB_HOST'))                        define('DB_HOST','31.11.39.104');
if (!defined('DB_USERNAME'))                    define('DB_USERNAME','Sql1708424');
if (!defined('DB_PASSWORD'))                    define('DB_PASSWORD' ,'t37(aESjW@IToJx');
